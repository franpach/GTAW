...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2017 a las 11:46:03
...
ALTER TABLE `megusta_op`
  ADD PRIMARY KEY (`id_usuario`,`id_opinion`),
  ADD KEY `id_opinion` (`id_opinion`);
